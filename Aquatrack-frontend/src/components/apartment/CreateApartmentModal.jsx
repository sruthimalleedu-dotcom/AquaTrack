...
export default function CreateApartmentModal({ open, onClose, onSuccess }) {
  // ==========================================
  // State
  // ==========================================
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Ambient Glow Orbs */}
            <div className="pointer-events-none absolute -top-16 -right-16 w-56 h-56 bg-cyan-500/10 rounded-full blur-3xl" />
            <div className="pointer-events-none absolute -bottom-12 -left-12 w-40 h-40 bg-blue-500/10 rounded-full blur-2xl" />
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 font-medium">
                      Register a new apartment community to the platform.
                    </p>
                  </div>
                </div>
